...
orientation: {
  ...
  roll : 0.0 // No roll
            ...
            destination: Cesium.Cartesian3.fromDegrees(-118.2265, 33.7340, 16000),
          orientation: {
          ...
          roll : 0.0 // No roll
            ...
            destination: Cesium.Cartesian3.fromDegrees(-118.240, 33.740, 2000), // Adjusted for close-up view
            orientation: {
...
"</ul>",
         destination: Cesium.Cartesian3.fromDegrees(-118.9000, 33.70146, 163734.072), // Approximate location over the port
         orientation: {
...
"</ul>",            
     destination: Cesium.Cartesian3.fromDegrees(-118.2050, 33.7300, 3500), // This brings the camera closer to the ground
     orientation: {
...
"<p><li>Nitrogen Oxides (NOx) by 62% </p></li>" + 
        "</ul>", 
           destination: Cesium.Cartesian3.fromDegrees(-118.1550, 33.7150, 3800), // These coordinates position the camera above the port area.
           orientation: {
...
"<p>In its continued efforts to modernize, the Port has implemented shore power at several terminals, enabling ships to connect to the electrical grid while docked, thereby substantially reducing auxiliary engine use. Concurrently, the transition to zero-emissions cargo handling equipment is in progress, marked by the introduction of electric yard trucks and forklifts. Exploring hydrogen fuel cells as an alternative power source for cargo handling equipment and ships, and offering incentives for using clean energy and green technologies to vessels and trucking companies, are also a key part of the Port's forward-thinking strategy.</p>",  
       destination: Cesium.Cartesian3.fromDegrees(-118.300, 33.730, 2000), // This sets the camera above the port area with containers in view.
orientation: {
...
destination: Cesium.Cartesian3.fromDegrees(-118.195, 33.732, 9550), // Adjust the coordinates and height to get the right angle and zoom level.
orientation: {
...
orientation: {
  ...
  roll: 0.0  // Level horizon
            ...
            destination: Cesium.Cartesian3.fromDegrees(-118.3020, 33.7600, 12500),
          orientation: {
