...
orientation: {
  ...
  roll : 0.0 // No roll
          ...
          roll : 0.0 // No roll
            ...
            destination: Cesium.Cartesian3.fromDegrees(-118.216, 33.74940, 1100), // Adjusted for close-up view
            orientation: {
...
"</ul>",
         destination: Cesium.Cartesian3.fromDegrees(-119, 31.5, 150000), // Approximate location over the port
         orientation: {
