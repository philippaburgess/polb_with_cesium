(function() {
 ...
 const locations = [
        ...
        Cesium.Cartesian3.fromDegrees(-118.1660, 33.7657, 3000)  // Bluff Park (Residential Area)
...
orientation: {
  ...
  roll : 0.0 // No roll
            ...
            destination: Cesium.Cartesian3.fromDegrees(-118.2265, 33.714, 16000),
          orientation: {
          ...
          roll : 0.0 // No roll
            ...
            destination: Cesium.Cartesian3.fromDegrees(-118.225, 33.746, 1500), // Adjusted for close-up view
            orientation: {
...
"</ul>",
         destination: Cesium.Cartesian3.fromDegrees(-123.2, 33.4, 163734.072), // Approximate location over the port
         orientation: {
...
"<p><li>Nitrogen Oxides (NOx) by 62% </p></li>" + 
        "</ul>", 
           destination: Cesium.Cartesian3.fromDegrees(-118.1550, 33.7595, 3800), // These coordinates position the camera above the port area.
           orientation: {
...
"<p><li>Educational and Workforce Development: Raises awareness about port operations and offers training programs, strengthening the local workforce.</li></p>" + 
                "</ul>",
destination: Cesium.Cartesian3.fromDegrees(-118.255, 33.715, 3600), // Adjusted coordinates for the desired view
orientation: {
